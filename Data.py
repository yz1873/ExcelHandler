...
ktSqlStr = "select LEFT(o.province_name,2) '省分公司', p.real_nums '采购数量', " \
             ...
             "GROUP BY p.id " %end_data
ktInfo = "空调（单位：台）"
ktSupplier = ['TCL空调', '艾默生网络', '北京斯泰科', '广东海悟', '广东科龙',
              '美的暖通', '美的制冷', '海信空调', '南京佳力图', '艾特网能']

ktTotalBiddingData = [3496, 203, 734, 4113, 3973, 724, 3531, 3932, 564, 759]

ktBiddingData = {'北京': [0, 17151, 16500, 16443, 0, 0, 15881, 15425, 0, 0],
                 '天津': [0, 373360, 359184, 357944, 0, 0, 345717, 335794, 0, 0],
                 '河北': [0, 58204, 55994, 55800, 0, 0, 53894, 52347, 0, 0],
                 '山西': [0, 198901, 191349, 190688, 0, 0, 184174, 178888, 0, 0],
                 '内蒙': [0, 71311, 68604, 68367, 0, 0, 66032, 64136, 0, 0],
                 '辽宁': [0, 55571, 53482, 53295, 53161, 52171, 0, 0, 0, 0],
                 '吉林': [0, 24165, 23257, 23175, 23117, 22686, 0, 0, 0, 0],
                 '黑龙': [0, 22686, 21834, 21758, 21703, 21299, 0, 0, 0, 0],
                 '上海': [0, 147983, 142423, 141924, 141568, 138930, 0, 0, 0, 0],
                 '江苏': [0, 16525, 15904, 15848, 15809, 15514, 0, 0, 0, 0],
                 '浙江': [0, 216850, 208703, 207972, 207450, 203585, 0, 0, 0, 0],
                 '安徽': [0, 38391, 36949, 36819, 36727, 36042, 0, 0, 0, 0],
                 '福建': [0, 21591, 20779, 20706, 20654, 20270, 0, 0, 0, 0],
                 '江西': [0, 3508, 3377, 3365, 3356, 3294, 0, 0, 0, 0],
                 '山东': [0, 432123, 415888, 414431, 413390, 405688, 0, 0, 0, 0],
                 '河南': [0, 64111, 61677, 61467, 0, 0, 0, 0, 57319, 55996],
                 '湖北': [0, 17428, 16767, 16710, 0, 0, 0, 0, 15582, 15223],
                 '湖南': [0, 67070, 64523, 64303, 0, 0, 0, 0, 59964, 58580],
                 '广东': [0, 26770, 25754, 25666, 0, 0, 0, 0, 23934, 23382],
                 '广西': [0, 13651, 13133, 13088, 0, 0, 0, 0, 12205, 11923],
                 '海南': [0, 13574, 13058, 13014, 0, 0, 0, 0, 12135, 11855],
                 '重庆': [0, 26127, 25135, 25048, 0, 0, 24192, 23498, 0, 0],
                 '四川': [0, 33712, 32432, 32320, 0, 0, 31216, 30320, 0, 0],
                 '贵州': [0, 32462, 31229, 31121, 0, 0, 30058, 29196, 0, 0],
                 '云南': [0, 45828, 44087, 43935, 0, 0, 42434, 41216, 0, 0],
                 '西藏': [0, 36746, 35351, 35229, 0, 0, 34025, 33049, 0, 0],
                 '陕西': [0, 124145, 119480, 119062, 118763, 116550, 0, 0, 0, 0],
                 '甘肃': [0, 8852, 8519, 8490, 8468, 8311, 0, 0, 0, 0],
                 '青海': [0, 5238, 5041, 5023, 5011, 4917, 0, 0, 0, 0],
                 '宁夏': [0, 6768, 6513, 6491, 6474, 6354, 0, 0, 0, 0],
                 '新疆': [0, 28524, 27453, 27356, 27288, 26779, 0, 0, 0, 0]}
