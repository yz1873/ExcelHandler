...
provider = ['江苏亨通', '中天科技', '江苏俊知', '成都大唐', '富通集团', '通鼎互联', '江苏中利', '鲁能泰山', '西部电缆', '江苏亨鑫', '珠海汉胜', '长飞光纤',
            '中天射频', '湖北凯乐', '广东海悟', '广东科龙', '海信空调', '美的制冷', 'TCL空调', '艾特网能', '北京斯泰科', '美的暖通', '南京佳力图',
            '艾默生网络', '珠江电信', '南京华脉', '中达电通', '东莞铭普', '北京动力源', '华为公司', '中兴公司', '爱立信公司', '上海贝尔']
...
dldlBiddingData = {'北京': [36114, 34743, 34623, 0, 0, 33440, 32480, 0, 0],
                   '天津': [354397, 340941, 339764, 0, 0, 328158, 318739, 0, 0],
...
kxSqlStr = "select LEFT(o.province_name,2) '省分公司', p.real_nums '采购数量', " \
           ...
           "GROUP BY p.id " % end_data
kxInfo = "馈线（单位：米）"
kxSupplier = ['江苏俊知', '江苏亨鑫', '珠海汉胜', '长飞光纤', '通鼎互联', '中天射频', '成都大唐', '富通集团', '湖北凯乐']
